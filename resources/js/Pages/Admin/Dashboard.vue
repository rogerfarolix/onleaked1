    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-6xl mx-auto space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link :href="route('admin.users.index')" class="glass-card rounded-lg p-5 hover:border-brand/30 transition-colors group">
          ...
          <Link :href="route('admin.technologies.index')" class="glass-card rounded-lg p-5 hover:border-brand/30 transition-colors group">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-md bg-brand/10 border border-brand/25 flex items-center justify-center group-hover:bg-brand/20 transition-colors">
          ...
          <Link :href="route('admin.logs.index')" class="glass-card rounded-lg p-5 hover:border-brand/30 transition-colors group">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 rounded-md bg-brand/10 border border-brand/25 flex items-center justify-center group-hover:bg-brand/20 transition-colors">
