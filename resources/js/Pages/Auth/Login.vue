    ...
    <div class="gradient-bg min-h-screen flex items-center justify-center px-4 py-12">
      <div class="w-full max-w-md">
          ...
          <form @submit.prevent="submit" class="space-y-5">
            ...
            <div>
              <div class="flex items-center justify-between mb-1.5">
                ...
                <Link href="/forgot-password" class="text-xs text-violet-400 hover:text-violet-300 transition-colors">Forgot password?</Link>
              </div>
              <input
            ...
            <label class="flex items-center gap-3 cursor-pointer">
              <input v-model="form.remember" type="checkbox" class="w-4 h-4 rounded border-white/10 bg-white/5 text-violet-500 focus:ring-violet-500/30" />
        ...
        <p class="text-center text-zinc-500 text-sm mt-6">
          ...
          <Link href="/register" class="text-violet-400 hover:text-violet-300 transition-colors ml-1">Create one free</Link>
        </p>
