    ...
    <div class="py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <a href="{{ route('admin.users.index') }}" class="glass-card rounded-2xl p-5 hover:border-violet-500/30 transition-colors group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <p class="font-semibold text-white">Users</p>
                            <p class="text-xs text-zinc-500">Manage roles & access</p>
                        </div>
                    </div>
                </a>
                <a href="{{ route('admin.technologies.index') }}" class="glass-card rounded-2xl p-5 hover:border-emerald-500/30 transition-colors group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-zinc-500">Add & remove tracked tech</p>
                        </div>
                    </div>
                </a>
                <a href="{{ route('admin.logs.index') }}" class="glass-card rounded-2xl p-5 hover:border-amber-500/30 transition-colors group">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-zinc-500">View admin actions</p>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="glass-card rounded-2xl overflow-hidden">
                <div class="px-6 py-4 border-b border-white/5 flex items-center justify-between">
                    ...
                    <a href="{{ route('admin.logs.index') }}" class="text-xs text-zinc-500 hover:text-white transition-colors">View all →</a>
                </div>
                @if($recentLogs->isEmpty())
                    <p class="px-6 py-8 text-center text-zinc-600 text-sm">No admin activity yet.</p>
                @else
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-white/5">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-3 text-zinc-600 text-xs">{{ $log->created_at?->diffForHumans() }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
